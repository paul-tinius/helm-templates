#!/bin/bash
# Installation script for the Spring Boot example application chart
...
usage() {
    ...
    echo ""
    echo "Options:"
    echo "  -n, --name NAME          Release name (default: springboot-app)"
...
echo "=========================================="
echo "Installing Spring Boot Example Application Chart"
echo "=========================================="
